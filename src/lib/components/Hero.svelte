...
<KeyedMount>
  <section>
    <h1
      class="mt-20 font-serif text-9xl leading-[0.8] font-medium tracking-tight text-foreground md:text-8xl lg:text-9xl"
      in:fly|global={{ duration: 1500, delay: 500, x: -30 }}
    >
      The Cavendish
